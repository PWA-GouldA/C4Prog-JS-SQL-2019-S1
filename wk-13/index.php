...
?>
    ...
    <div class="row">
        <div class="col">
            <h1 class="mt-4"><?= isset($title) ? $title : 'Week 13' ?></h1>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="resources/Useful-Links.pdf">Useful Links</a>
        </div>
        <div class="col-12">
        ...
        <div class="col-4">
            <h4>Cities</h4>
            <?php
            if (getTableExists($conn, "cities")) {
                echo "<p class='alert alert-success'>Table Exists</p>";

                if (rowCount($conn, "cities") > 0) {
                    echo "<p class='alert alert-success'>Data present</p>";
                } else {
                    echo "<p  class='alert alert-danger'>Table empty</p>";
                }
        ...
        <div class="col-4">
            <h4>Countries</h4>
            <?php
            if (getTableExists($conn, "countries")) {
                echo "<p class='alert alert-success'>Table Exists</p>";

                if (rowCount($conn, "countries") > 0) {
                    echo "<p class='alert alert-success'>Data present</p>";
                } else {
                    echo "<p  class='alert alert-danger'>Table empty</p>";
                }
