<?php
/**
 * Template PHP file with HTML
 *
 * This file is NOT best practice, but provided as a stop gap
 */
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="../assets/js/c4prog.css"/>


    <title>Week 07 - Demo 00</title>
...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <h1 class="mt-4">Week 07 - Demo 00</h1>
        <h2 class="text-muted">Demo Name</h2>
        <p class="lead">Summary of the Demo</p>
        <p>Explanatory paragraph, if required.</p>
...
<script src="./js/demo-00.js"></script>
