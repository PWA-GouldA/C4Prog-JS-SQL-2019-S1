...
?>
    <div class="row">
        <div class="h2 col-6">All Contacts</div>

        <p class="col-6 text-right">
            <a class="btn btn-outline-primary" href="contact-add.php">Add</a>
            <a class="btn btn-outline-secondary" href="contact-browse.php">Browse</a>
        </p>
    </div>
            ...
            <table class='table'>
                ...
                foreach ($contacts as $row) {
                    ...
                    <tr>
                        ...
                        <td><a href="contact-delete.php?id=<?= $row->id ?>"><i class="fa fa-minus"></i> Delete</a>
                        </td>
                    </tr>
                    <?php
                }
